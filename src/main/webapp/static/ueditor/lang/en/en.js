...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'errorLoadConfig': 'Server com.scm.configuration not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigError': 'Get server com.scm.configuration error.',
    'loadconfigFormatError': 'Server com.scm.configuration format error.',
    'loadconfigHttpError': 'Get server com.scm.configuration http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the com.scm.configuration!",
